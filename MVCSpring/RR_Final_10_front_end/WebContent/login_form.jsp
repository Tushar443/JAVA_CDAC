...
<h1 style="text-align:center ;color:#3d3d5c;  margin-top:80px;margin-bottom: 30px">Login Form </h1>

	<spr:form action="login.htm" method="post" commandName="user" >
	<table align="center" height="250" width="350">
		<tr>
			<td>
				User Name:
			</td>
		...
		<tr align="center">
			...
			<td>
				<input type="submit" style="color:white; background-color: #7575a3;margin-top:5px;" value="Login" >
			</td>
		</tr>
		<tr align="center" >
			<td></td><td>
